...
function insert_from_type_id_image(){
    ...
    var loadSpaceImage_Location = "https://localhost:44476/content/drawings/svg/" + jQuery('#image_sensor_location').val();
...
function loadprocessedsvg(){
    ...
    var FileName = "https://localhost:44325"+ "/content/drawings/svg/testSVGnotprocessed.svg";
