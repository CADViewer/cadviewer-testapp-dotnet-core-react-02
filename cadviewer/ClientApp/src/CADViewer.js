...
function cvjs_OnLoadEnd(){
	...
	if (onloadEndFlag2){
		cadviewer.cvjs_loadSpaceObjectsDirect("floorPlan", "https://localhost:44476/content/SpaceObjects/testSpaceObjects.json")
//		cadviewer.cvjs_loadSpaceObjectsDirect("floorPlan", "https://localhost:44476/content/SpaceObjects/testSpaceObjects2.json")
	...
	// this illustrates how to set watermarks
	// cadviewer.cvjs_setWatermarks("Hello World-你好世界!", "这个真是好东西！2022-07-21", "#A3A3A3", true);
...
//		cadviewer.cvjs_setAllServerPaths_and_Handlers(ServerBackEndUrl, ServerUrl, ServerLocation, "dotNetCore", "ReactJS", "floorPlan");
...
//		cadviewer.cvjs_conversion_addAXconversionParameter("last", "");		 
		...
		// cadviewer.cvjs_resizeWindow_fixedSize(300, 300, "floorPlan");			   
	}
	...
	_handleWindowResize () {
        ...
        try{    
         //   cadviewer.cvjs_resizeWindow_position("floorPlan" );
         //cadviewer.cvjs_resizeWindow_fixedSize(600, 400, "floorPlan");		
